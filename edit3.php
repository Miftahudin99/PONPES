<?php
    ...
    { 
        ...
        // update user data
        $result = mysqli_query($koneksi, "UPDATE data_ponpes SET sejarah='$sejarah' WHERE id=$id");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="main">
            <h3>Update Data Pondok Pesantren - <i><?php echo $ponpes; ?></i></h3>
            <form action="edit3.php" method="post">
                <div class="container">
                    <input type="hidden" name="id" value="<?php echo $_GET['id'];?>">
                    
                    <div class="mb-3">
                        <label for="Input2" class="form-label">Sejarah Singkat</label>
                        <div class="container">
                            <textarea class="form-control" id="Input2" name="sejarah" rows="8" cols="50"><?php echo $sejarah; ?></textarea>
                        </div>
                    </div>
